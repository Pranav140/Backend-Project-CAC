...
const loginUser = asyncHandler(async (req, res) => {
    ...
    if (!isPasswordValid) {
        throw new ApiError(401, "Invalid user cedentials")
    }
...
const updateAccountDetails = asyncHandler(async(req,res)=>{
    ...
    return res
    .status(200)
    .json(new ApiResponse(200,user,"Account details are required"))
})
...
const updateUserCoverImage = asyncHandler(async(req,res)=>{
    ...
    .status(200)
    .json(
        new ApiResponse(200,user,"CoverImage changed")
    )
})
...
export {
    registerUser, loginUser, logoutUser, refreshAccessToken, getCurrentUser, changeCurrentPassword , updateAccountDetails , updateUserAvatar , updateUserCoverImage , getUserChannelProfile , getWatchHistory
}